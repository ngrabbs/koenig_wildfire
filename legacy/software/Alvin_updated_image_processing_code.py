# Source Attributed to Alvin - TODO: Update with Alvins details
# Need to update Alvins info

# importing required libraries
import matplotlib.pyplot as plt
import numpy as np
import cv2 as mrkitty
import os
...
def file_handling():
    ...
    for file in os.listdir(folder_path):
        ...
        ih = [0]*256
        img_file = mrkitty.imread(os.path.join(folder_path,file),0)
        ...
        # h_img = mrkitty.calcHist([img_file],[0],None,[256],[0,256])
...
# result = file_handling()
# M = mrkitty.imread("C:\\Users\\alvin\\PycharmProjects\\5 pic histogram\\F_760_1.jpg",0)
# M_array = np.array(M)
